<template>
  ...
  <div class="row g-6 g-xl-9">
    ...
    <!--begin::Col-->
    <div   @on-sort="sort" @on-items-select="onItemSelect" :data="DataConge"
...
<!--begin::Col-->
<div  @on-sort="sort" @on-items-select="onItemSelect" :data="DataAbs"
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(async () => {
      ...
      console.log("verification"+demandesAbs);
    });
