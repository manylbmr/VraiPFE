        ...
        <el-form @submit.prevent="submit()" :model="formData" :rules="rules" ref="formRef">
          ...
          <div class="fv-row mb-7">
            ...
            <el-form-item prop="nameAr">
              <el-input v-model="formData.nameAr" type="text" placeholder="" />
            </el-form-item>
            <!--end::Input-->
          </div>
          <!--end::Input group-->
          ...
          <div class="fv-row mb-7">
            ...
            <el-form-item prop="prenomAr">
              <el-input v-model="formData.prenomAr" type="text" placeholder="" />
            </el-form-item>
            <!--end::Input-->
          </div>
          <!--end::Input group-->
          ...
          <div class="fv-row mb-7">
            ...
            <el-form-item prop="ndjf">
              <el-input v-model="formData.ndjf" type="text" placeholder="" />
            </el-form-item>
            <!--end::Input-->
          </div>
          <!--end::Input group-->
          ...
          <div class="fv-row mb-7">
            ...
            <el-form-item prop="ndjfAr">
              <el-input v-model="formData.ndjfAr" type="text" placeholder="" />
            </el-form-item>
            <!--end::Input-->
          </div>
          <!--end::Input group-->
          ...
          <div class="fv-row mb-7">
            ...
            <el-form-item prop="ddn">
              <el-input v-model="formData.ddn" type="date" placeholder="" />
            </el-form-item>
            <!--end::Input-->
          </div>
          <!--end::Input group-->
          ...
          <div class="fv-row mb-7">
            ...
            <el-form-item prop="ldn">
              <el-input v-model="formData.ldn" type="text" placeholder="" />
            </el-form-item>
            <!--end::Input-->
          </div>
          <!--end::Input group-->
          ...
          <div class="d-flex flex-column mb-7 fv-row">
            ...
            <el-select v-model="formData.equipe">
              <el-option value="">Chosissez une equipe</el-option>
              <el-option v-for="(item, i) in countries" :key="`countries-select-option-${i}`" :value="item.code">
                {{ item.name }}
              </el-option>
            </el-select>
          ...
          <div class="d-flex flex-column mb-7 fv-row">
            ...
            <label class="fs-6 fw-semibold mb-2">
              ...
              <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Situation Familiale"></i>
            </label>
            <!--end::Label-->
          ...
          <div class="fv-row mb-7">
            ...
            <label class="fs-6 fw-semibold mb-2">
              ...
              <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                title="Telephone doit etre actif"></i>
            </label>
            <!--end::Label-->
          ...
          <div class="d-flex flex-column mb-7 fv-row">
            <!--begin::Label-->
            <label class="required fs-6 fw-semibold mb-2">Addresse</label>
            <!--end::Label-->
